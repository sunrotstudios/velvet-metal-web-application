...
export const getAppleMusicPlaylistDetails = async (
  ...
  try {
    ...
    console.log('Fetching Apple Music playlist details...');
    ...
    throw error instanceof Error
      ? error
      : new Error('Unknown error fetching Apple Music playlist');
  }
};
...
export const getAppleMusicAlbumDetails = async (
  ...
  try {
    ...
    throw error instanceof Error
      ? error
      : new Error('Unknown error fetching Apple Music album');
  }
};
