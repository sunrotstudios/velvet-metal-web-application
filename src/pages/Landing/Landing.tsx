        ...
        >
          <div className="space-y-3 md:space-y-6">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <motion.h1
                className="text-4xl sm:text-5xl md:text-6xl lg:text-8xl font-black text-right w-2/3 md:w-1/2 font-mondwest"
                style={{
                  fontFamily: "Mondwest",
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-6">
                ...
                <div className="border-2 border-black rounded-full bg-white overflow-hidden">
                  <div className="flex items-center justify-between h-12 w-full px-8">
                    <div className="flex items-center justify-start gap-0">
                      <Link
                        to="/about"
                        className="py-2 text-base font-medium font-body mr-10 relative group hover:line-through decoration-2"
                      >
                        ABOUT
                      </Link>
                      <Link
                      ...
                      <Link
                        to="/contact"
                        className="py-2 text-base font-medium font-body relative group hover:line-through decoration-2"
                      >
                        CONTACT
                      </Link>
                    </div>
              ...
              <div className="hidden md:flex items-center justify-center gap-4">
                ...
                <button
                  ...
                  style={{
                    backgroundImage:
                      "repeating-linear-gradient(-45deg, transparent, transparent 5px, rgba(245, 158, 11, 0.1) 5px, rgba(245, 158, 11, 0.1) 10px)",
                  }}
                >
                  SIGN IN
                </button>
            ...
            <div className="relative h-2 md:h-4 my-1">
              ...
              >
                <path
                  d="M0 0L50 12L100 0L150 12L200 0L250 12L300 0L350 12L400 0L450 12L500 0L550 12L600 0L650 12L700 0L750 12L800 0L850 12L900 0L950 12L1000 0L1050 12L1100 0L1150 12L1200 0"
                  stroke="black"
                  strokeWidth="2"
                />
              </svg>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-6">
              <div className="md:col-span-2">
                <div className="overflow-hidden rounded-xl md:rounded-3xl border-2 md:border-4 border-black relative h-40 md:h-64">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-white px-2 md:px-6 py-1.5 md:py-4 border-t-2 md:border-t-4 border-black flex items-center justify-between">
                    <div>
                      <h2 className="text-sm md:text-xl font-bold leading-tight font-title">
                        VISIONS OF YOU
                      </h2>
                      <p className="text-xs md:text-base font-body">
                        By Isa Ma
                      </p>
                    </div>
                    <div className="bg-orange-400 rounded-full w-8 h-8 md:w-14 md:h-14 border-2 md:border-4 border-black flex items-center justify-center cursor-pointer transform rotate-45 hover:bg-orange-500 transition-colors">
                      <div className="transform -rotate-45 text-base md:text-xl">
                        →
                      </div>
                    </div>
                  </div>
              ...
              <div className="md:col-span-1">
                <div
                  className="border-2 md:border-4 border-black rounded-xl md:rounded-3xl p-2 md:p-4 bg-purple-100 h-auto min-h-[160px] md:h-64 relative"
                  style={{
                    backgroundImage:
                      "repeating-linear-gradient(-45deg, transparent, transparent 5px, rgba(168, 85, 247, 0.1) 5px, rgba(168, 85, 247, 0.1) 10px)",
                  }}
    ...
    `,
              ...
              <div className="relative z-10">
                <h2 className="text-base sm:text-xl md:text-4xl font-black text-white uppercase tracking-tighter font-title leading-tight mb-3 md:mb-4">
                  All Great Music Collections Begin When You Hear Yourself In
                  Another
                </h2>
                <button className="bg-black text-white px-4 md:px-6 py-2 md:py-3 rounded-md md:rounded-xl font-bold text-xs md:text-lg border-2 md:border-4 border-white hover:opacity-90 transition-opacity">
                  JOIN COMMUNITY
                </button>
              </div>
            </div>
